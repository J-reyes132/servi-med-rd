                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    <form method="POST" action="{{ route('admin.doctor.store') }}">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="especialidad" id="especialidad" value="{{ old('especialidad') }}" class="block w-full mt-1 border-gray-300 rounded-md shadow-sm">
                            @error('especialidad')
                                <span class="text-red-600 text-sm">{{ $message }}</span>
                            @enderror
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="exequatur" id="exequatur" value="{{ old('exequatur') }}" class="block w-full mt-1 border-gray-300 rounded-md shadow-sm">
                            @error('exequatur')
                                <span class="text-red-600 text-sm">{{ $message }}</span>
                            @enderror
                        </div>
