...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="bg-gray-900 text-white">
        <div class="bg-gray-800 shadow-md" x-data="{ isOpen: false }">
            <nav class="container px-6 py-8 mx-auto md:flex md:justify-between md:items-center">
                <div class="flex items-center justify-between">
                    <a class="text-xl font-bold text-red-700 md:text-2xl hover:text-green-400"
                        href="/">
                        Servi Med RD
                    </a>
                    <!-- Mobile menu button -->
                ...
                <div :class="isOpen ? 'flex' : 'hidden'"
                    ...
                    <a class="text-red-500 font-bold hover:text-green-400"
                        href="/">Inicio</a>
                    <a class="text-red-500 hover:text-green-400"
        ...
        <div class="font-sans min-h-screen bg-gray-900 text-white antialiased">
            {{ $slot }}
        </div>
