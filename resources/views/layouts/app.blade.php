    ...
    <div class="flex min-h-screen">
        ...
        <div class="w-64 bg-blue-500 text-white p-4 flex flex-col space-y-4">
            ...
            <nav class="space-y-2">
                ...
                <x-admin-nav-link href="{{ route('paciente.cita.index') }}">Citas</x-admin-nav-link>
                <x-admin-nav-link href="{{ route('paciente.historial.index') }}">Historiales Médicos</x-admin-nav-link>
            </nav>
